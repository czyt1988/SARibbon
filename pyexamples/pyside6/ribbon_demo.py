"""
SARibbon Python Demo (PySide6)
==============================

A self-contained demo showing how to use SARibbon via PySide6 Python bindings.
...
Prerequisites:
  pip install PySide6
  Build and install PySideSARibbon first (see tools/build_pyside6_bindings.bat)
...
def main():
    ...
    win.setWindowTitle("SARibbon Python Demo (PySide6)")
    win.resize(1280, 800)
    ...
    editor.setPlaceholderText("SARibbon Python Demo (PySide6) - type here...")
    ...
    ribbon.actionTriggered.connect(
        lambda act: print("[PySide6] Action: {}".format(act.text()))
    )
