...
/*** Start of inlined file: qrc_resource.cpp ***/
static const unsigned char qt_resource_data[] = {
	...
	// F:/src/SARibbon/src/SARibbonBar/resource/ribbonPannelOptionButton.png
    0x0,
    0x0,
    0x1,
    0x4b,
...
struct initializer
{
    initializer()
    {
        QT_RCC_MANGLE_NAMESPACE(qInitResources_resource)();
    }
    ~initializer()
    {
        QT_RCC_MANGLE_NAMESPACE(qCleanupResources_resource)();
    }
} dummy;
}

/*** End of inlined file: qrc_resource.cpp ***/
